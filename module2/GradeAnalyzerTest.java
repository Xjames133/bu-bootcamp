...
public class GradeAnalyzerTest {
    ...
    @Test
    void calculateAverage_returnsCorrectAverage_whenlisthastenitems(){
        ArrayList<Integer> scores = new ArrayList<>(Arrays.asList(1,2,3,4,5,6,7,8,9,0));
        assertEquals(4.5, GradeAnalyzer.calculateAverage(scores));
    }
} 